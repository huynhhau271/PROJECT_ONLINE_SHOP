...
test.beforeEach(async ({ page }) => {
  ...
  test('TC1 - Products: Nhập mới thành công', async ({ page }) => {
    // Khai báo biến
    const category = 'Nguyễn';
    const supplier = 'Văn A 1234';
    const name = 'Product 01 A';
    const price = '10';
    const discount = '5';
    const stock = '7';
  ...
  test('TC2 - Products: Cập nhật thành công', async ({ page }) => {
    // Khai báo biến
    const category = 'Nguyễn 1';
    const supplier = 'Văn B 1234';
    const name = 'Product 02 A';
    const price = '10';
    const discount = '5';
    const stock = '8';
    ...
    await page.getByRole('dialog', { name: 'Update Product' }).getByLabel('Category').fill(category);
    await page.getByRole('dialog', { name: 'Update Product' }).getByLabel('Supplier').fill(supplier);
    ...
    await page.getByRole('dialog', { name: 'Update Producte' }).getByLabel('Stock').fill(stock);
