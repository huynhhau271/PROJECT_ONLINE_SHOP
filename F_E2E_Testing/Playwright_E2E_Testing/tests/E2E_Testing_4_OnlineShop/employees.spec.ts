...
test.beforeEach(async ({ page }) => {
  ...
  test('TC1 - Employees: Nhập mới thành công', async ({ page }) => {
    // Khai báo biến
    const firstname = 'Nguyễn';
    const lastname = 'Văn A 1234';
    const phone = '090571234';
    const email = 'email88881234@gmail.com';
    const address = '38 Yên Bái';
    const birthday = '08 Jan 2002';
  ...
  test('TC2 - Employees: Cập nhật thành công', async ({ page }) => {
    ...
    const lastname = 'Văn A 1234';
    const phone = '090571234';
    const email = 'newemail88881234@gmail.com';
    const address = '38 Yên Bái Đà Nẵng';
    const birthday = '19 Jan 2002';
    ...
    await page.getByRole('dialog', { name: 'Update Employee' }).getByLabel('FirstName').fill(firstname);
    await page.getByRole('dialog', { name: 'Update Employee' }).getByLabel('LastName').fill(lastname);
